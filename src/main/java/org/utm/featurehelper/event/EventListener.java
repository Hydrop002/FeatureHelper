...
public class EventListener {
    ...
    public void onChunkLoad(ChunkEvent.Load event) {
        if (!event.getWorld().isClientSide()) {
            ...
            //Heightmap heightMap = chunk.getOrCreateHeightmapUnprimed(Heightmap.Type.WORLD_SURFACE);
            //chunk.heightmaps.put(Heightmap.Type.WORLD_SURFACE_WG, heightMap);
            //heightMap = chunk.getOrCreateHeightmapUnprimed(Heightmap.Type.OCEAN_FLOOR);
