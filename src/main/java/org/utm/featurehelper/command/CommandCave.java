...
public class CommandCave extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        if (args[0].equals("start")) {
            ...
            notifyOperators(sender, this, "commands.cave.start.success", x, y, z);
            ...
            if (current != null) {
                ...
                notifyOperators(sender, this, "commands.cave.continue.success", pos.xCoord, pos.yCoord, pos.zCoord);
            } else {
                notifyOperators(sender, this, "commands.cave.continue.complete");
            }
            ...
            if (args[1].equals("hide")) {
                ...
                notifyOperators(sender, this, "commands.cave.trail.hide.success");
            } else if (args[1].equals("show")) {
                this.showTrail((EntityPlayerMP) sender);
                notifyOperators(sender, this, "commands.cave.trail.show.success");
            } else {
                throw new WrongUsageException("commands.cave.trail.usage");
            }
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        if (args.length == 1)
            ...
            if (list.contains("tunnel"))
                notifyOperators(sender, this, "commands.cave.start.tunnel.usage");
            if (list.contains("room"))
                notifyOperators(sender, this, "commands.cave.start.room.usage");
            return list;
