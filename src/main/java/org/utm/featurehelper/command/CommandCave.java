...
public class CommandCave extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        if (args[0].equals("start")) {
            ...
            notifyCommandListener(sender, this, "commands.cave.start.success", x, y, z);
            ...
            if (current != null) {
                ...
                notifyCommandListener(sender, this, "commands.cave.continue.success", pos.x, pos.y, pos.z);
            } else {
                notifyCommandListener(sender, this, "commands.cave.continue.complete");
            }
            ...
            if (args[1].equals("hide")) {
                ...
                notifyCommandListener(sender, this, "commands.cave.trail.hide.success");
            } else if (args[1].equals("show")) {
                this.showTrail((EntityPlayerMP) sender);
                notifyCommandListener(sender, this, "commands.cave.trail.show.success");
            } else {
                throw new WrongUsageException("commands.cave.trail.usage");
            }
    ...
    public List<String> getTabCompletions(MinecraftServer server, ICommandSender sender, String[] args, @Nullable BlockPos pos) {
        if (args.length == 1)
            ...
            if (list.contains("tunnel"))
                notifyCommandListener(sender, this, "commands.cave.start.tunnel.usage");
            if (list.contains("room"))
                notifyCommandListener(sender, this, "commands.cave.start.room.usage");
            return list;
