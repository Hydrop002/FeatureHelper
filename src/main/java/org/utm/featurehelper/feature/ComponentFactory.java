    ...
    static {
        ...
        factory.put("MSCorridor", new IComponent() {
            ...
            public StructureComponent getComponent(World world, int x, int y, int z, Random rand) {
                ...
                StructureBoundingBox bb = StructureMineshaftPieces.Corridor.func_175814_a(empty, rand, x, y, z, face);
        ...
        factory.put("MSCrossing", new IComponent() {
            ...
            public StructureComponent getComponent(World world, int x, int y, int z, Random rand) {
                EnumFacing face = EnumFacing.Plane.HORIZONTAL.random(rand);
                StructureBoundingBox bb = StructureMineshaftPieces.Cross.func_175813_a(empty, rand, x, y, z, face);
        ...
        factory.put("MSStairs", new IComponent() {
            ...
            public StructureComponent getComponent(World world, int x, int y, int z, Random rand) {
                EnumFacing face = EnumFacing.Plane.HORIZONTAL.random(rand);
                StructureBoundingBox bb = StructureMineshaftPieces.Stairs.func_175812_a(empty, rand, x, y, z, face);
        ...
        factory.put("ViSR", new IComponent() {  // 路
            ...
            public StructureComponent getComponent(World world, int x, int y, int z, Random rand) {
                EnumFacing face = EnumFacing.Plane.HORIZONTAL.random(rand);
                StructureVillagePieces.Start start = new StructureVillagePieces.Start(world.getWorldChunkManager(), 0, rand, x, z, empty, 0);
                StructureBoundingBox bb = StructureVillagePieces.Path.func_175848_a(start, empty, rand, x, y, z, face);
        ...
        factory.put("OMB", new IComponent() {
            @Override
            public StructureComponent getComponent(World world, int x, int y, int z, Random rand) {
                EnumFacing face = EnumFacing.Plane.HORIZONTAL.random(rand);
                StructureOceanMonumentPieces.MonumentBuilding building = new StructureOceanMonumentPieces.MonumentBuilding(rand, x, z, face);
                // building.field_175843_q.clear();
                try {
                    Field rooms = StructureOceanMonumentPieces.MonumentBuilding.class.getDeclaredField("field_175843_q");
                    rooms.setAccessible(true);
                    ((List<StructureOceanMonumentPieces.Piece>) rooms.get(building)).clear();
                    return building;
        ...
        factory.put("OMCR", new IComponent() {
            @Override
            public StructureComponent getComponent(World world, int x, int y, int z, Random rand) {
                EnumFacing face = EnumFacing.Plane.HORIZONTAL.random(rand);
        ...
        factory.put("OMDYZR", new IComponent() {
            @Override
            public StructureComponent getComponent(World world, int x, int y, int z, Random rand) {
                EnumFacing face = EnumFacing.Plane.HORIZONTAL.random(rand);
                StructureOceanMonumentPieces.RoomDefinition room = new StructureOceanMonumentPieces.RoomDefinition(0);
                ...
                room.func_175957_a(EnumFacing.NORTH, north);
                room.func_175957_a(EnumFacing.UP, up);
                north.func_175957_a(EnumFacing.UP, northUp);
                StructureOceanMonumentPieces.DoubleYZRoom piece = new StructureOceanMonumentPieces.DoubleYZRoom(face, room, rand);
                piece.getBoundingBox().offset(x, y, z);
                return piece;
            }
        });
        factory.put("OMDZR", new IComponent() {
            @Override
            public StructureComponent getComponent(World world, int x, int y, int z, Random rand) {
                EnumFacing face = EnumFacing.Plane.HORIZONTAL.random(rand);
                StructureOceanMonumentPieces.RoomDefinition room = new StructureOceanMonumentPieces.RoomDefinition(0);
        ...
        factory.put("OMEntry", new IComponent() {
            @Override
            public StructureComponent getComponent(World world, int x, int y, int z, Random rand) {
                EnumFacing face = EnumFacing.Plane.HORIZONTAL.random(rand);
                StructureOceanMonumentPieces.RoomDefinition room = new StructureOceanMonumentPieces.RoomDefinition(0);
        ...
        factory.put("OMPenthouse", new IComponent() {
            @Override
            public StructureComponent getComponent(World world, int x, int y, int z, Random rand) {
                EnumFacing face = EnumFacing.Plane.HORIZONTAL.random(rand);
                StructureBoundingBox bb = StructureBoundingBox.func_175899_a(x, y, z, x + 13, y + 4, z + 13);
                return new StructureOceanMonumentPieces.Penthouse(face, bb);
            }
        });
        factory.put("OMSimple", new IComponent() {
            @Override
            public StructureComponent getComponent(World world, int x, int y, int z, Random rand) {
                EnumFacing face = EnumFacing.Plane.HORIZONTAL.random(rand);
                StructureOceanMonumentPieces.RoomDefinition room = new StructureOceanMonumentPieces.RoomDefinition(0);
        ...
        factory.put("OMSimpleT", new IComponent() {
            @Override
            public StructureComponent getComponent(World world, int x, int y, int z, Random rand) {
                EnumFacing face = EnumFacing.Plane.HORIZONTAL.random(rand);
                StructureOceanMonumentPieces.RoomDefinition room = new StructureOceanMonumentPieces.RoomDefinition(0);
