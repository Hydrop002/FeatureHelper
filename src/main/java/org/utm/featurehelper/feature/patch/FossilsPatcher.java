...
public class FossilsPatcher extends WorldGenFossils {
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        template.addBlocksToWorld(worldIn, blockpos1, placementsettings, 18);
        placementsettings.setIntegrity(0.1F);
        template1.addBlocksToWorld(worldIn, blockpos1, placementsettings, 18);
        return true;
    }
