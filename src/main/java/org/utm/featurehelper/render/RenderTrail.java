            ...
            while (tunnel.hasNext()) {
                ...
                if (tunnel.hasNext() || entity.ticksExisted % 20 < 10) {
                    ...
                    if (this.camera.isBoundingBoxInFrustum(aabb)) {
                        ...
                        GlStateManager.translated(pos.x - cameraX, pos.y - cameraY, pos.z - cameraZ);
                        GlStateManager.rotatef(180.0F - viewY, 0.0F, 1.0F, 0.0F);
                        GlStateManager.rotatef(-viewX, 1.0F, 0.0F, 0.0F);
                    ...
                    if (prevPos != null) {
                        ...
                        if (this.camera.isBoundingBoxInFrustum(lineAABB)) {
                            GlStateManager.pushMatrix();
                            GlStateManager.translated(-cameraX, -cameraY, -cameraZ);
                            GlStateManager.depthMask(false);
                            GlStateManager.disableTexture2D();
                            GlStateManager.disableLighting();
                            GlStateManager.disableCull();
